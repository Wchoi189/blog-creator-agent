# === Blog Creator Agent Development Environment .bashrc ===
...
# Blog Creator Agent Project aliases
alias run-backend='uv run python -m backend.main'
alias run-frontend='cd frontend && npm run dev'
