...
```
You are working on the blog-creator-agent project which uses AgentQMS for quality management.
...
```bash
qwen --approval-mode yolo --include-directories /workspaces/blog-creator-agent --prompt "[paste your prompt here]"
```