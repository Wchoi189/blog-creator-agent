...
# System executes:
qwen --approval-mode yolo --include-directories /workspaces/blog-creator-agent \
...
<parameter name="filePath">/workspaces/blog-creator-agent/.qwen/README-chat-integration.md