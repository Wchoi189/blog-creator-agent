...
PROJECT_ROOT="/workspaces/blog-creator-agent"
...
run_qwen_agentqms() {
    ...
    echo "   2. Run: qwen --approval-mode yolo --include-directories /workspaces/blog-creator-agent --prompt \"<paste prompt here>\""
